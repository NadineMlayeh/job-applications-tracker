...
export const DEFAULT_FIELDS: Omit<FieldDefinition, "id" | "user_id">[] = [
  ...
  { field_key: "source", label: "Application method", field_type: "select", options: ["LinkedIn", "Company Website", "Referral", "Indeed", "Other"], is_visible: true, is_custom: false, sort_order: 3 },
  ...
  { field_key: "interview_date", label: "Interview Date", field_type: "date", options: [], is_visible: true, is_custom: false, sort_order: 9 },
  { field_key: "rejection_reason", label: "Rejection Reason", field_type: "text", options: [], is_visible: true, is_custom: false, sort_order: 10 },
  { field_key: "follow_up_date", label: "Follow-up Date", field_type: "date", options: [], is_visible: true, is_custom: false, sort_order: 11 },
  { field_key: "application_type", label: "Application", field_type: "select", options: ["Job", "PFE / Internship"], is_visible: true, is_custom: false, sort_order: 12 },
];
